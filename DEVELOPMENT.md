...
- extension revision: `9474207126c4e33b670dac54973d0a803772e3c9`;
...
git -C libs/inkybit checkout --detach 9474207126c4e33b670dac54973d0a803772e3c9
nvm use
...
The automated browser smoke boots the labelled editor and exercises: new
project -> Extensions -> bundled `inkybit` -> drag full-screen image block ->
open editor -> draw a pixel -> Done. It also checks the preview manifest against
the exact toolchain pin before the journey. Persistence and native compile are
